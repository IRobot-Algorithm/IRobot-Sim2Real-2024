...
class router:
    ...
    def __init__(self) -> None:
        ...
        self.mission_point = {
            ...
            0: ("home", [0.00, 0.00, 0.00], [0.02, 0.05]),
            12: ("block12", [0.246, 0.336, 5*pi/8], [0.025, 0.05]),#第一矿区右侧
            11: ("block11", [0.575, 0.989, pi], [0.025, 0.05]),
            13: ("block13", [0.091, 1.625, -pi/4], [0.025, 0.05]),#第一矿区的左侧

            22: ("block22", [2.385, 0.738, -pi/2], [0.05, 0.1]),
            21: ("block21", [1.810,-0.196, 0], [0.05, 0.1]),
            33: ("block33", [2.516, -0.768, pi/4], [0.05, 0.1]),

            31: ("block31", [1.458, 2.832,3*pi/4], [0.05, 0.1]),
            32: ("block32", [0.169, 2.893, pi / 4], [0.05, 0.1]),
            


            9: ("noticeboard", [0.009, 0.06, pi/8], [0.05, 0.1]),
